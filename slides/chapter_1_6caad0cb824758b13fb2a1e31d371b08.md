...
>> 
To subscribe to a Datastream, we'll need a broker like MQTT. MQTT is a publish/subscribe messaging protocol, designed to have a small footprint, making it ideal for IOT usecases.
