...
An MQTT system consists of a client connecting to a server (also called Broker), and can then either publish data to a topic, or subscribe to data in one or multiple topic.
